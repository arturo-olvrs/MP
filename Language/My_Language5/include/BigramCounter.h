...
public:
     ...
     * a frequency greater than 0. The language returned must be sorted.
     * Query method
...
private:
    /**
     * @brief Allocates new memory for the matrix of frequencies with @p nrows rows
     * and @p ncols columns.
     * @param nrows Number of rows to allocate for.
     * @param ncols Number of columns to allocate for.
     * @pre @p nrows must be greater than 0.
     * @pre @p ncols must be greater than 0.
     */
     ...
     * @pre The pointer of pointers _frequency should point to an array in dynamic
